...
extern unsigned short int cold3ctable[16];
extern byte cold3c[0x0800];

extern unsigned short int hot4table[16];
extern byte hot4[0x0800];

extern unsigned short int raingauge1table[16];
extern byte raingauge1[0x0800];

extern unsigned short int rooster2table[16];
extern byte rooster2[0x0800];


extern unsigned short int weather03btable[16];
extern byte weather03b[0x0800];

extern unsigned short int weather8dtable[16];
extern byte weather08d[0x0800];

extern  unsigned short int light2table[2];
extern   byte light2[0x0200];



UTFTESP32 myGLCD( CTE40,21,4,33,32);
